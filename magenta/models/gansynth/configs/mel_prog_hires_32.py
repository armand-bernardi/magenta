...
hparams['audio_length'] = 64000*2
hparams['sample_rate'] = 32000

# Training
hparams['data_type'] = data_type
hparams['total_num_images'] = 11*1000*100 if train_progressive else 4*1000*100
hparams['discriminator_learning_rate'] = lr
hparams['generator_learning_rate'] = lr
hparams['train_progressive'] = train_progressive
hparams['stable_stage_num_images'] = 800*100
hparams['transition_stage_num_images'] = 800*100
hparams['save_summaries_num_images'] = 10*100
